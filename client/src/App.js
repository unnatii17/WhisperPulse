...
function App() {
  ...
  return (
    <div
      className={`w-screen hind ${
        token ? "bg-white" : "bg-ring"
      } dark:bg-confettiDarkColor1 bg-cover bg-center min-h-screen flex flex-col`}
    >
      <MetaData />
      ...
      <AnimatePresence mode="wait">
        <Routes location={location} key={location.pathname}>
          ...
          <Route path="/feed" element={<Feed />}>
            ...
            <Route path="/feed/leaderboard" element={<Leaderboard />} />
            <Route path="/feed/stats" element={<Leaderboard />} />
