...
const SubmitButton = memo(function SubmitButton({text, type, disabled, customClasses="", onclick=null}){
  return (
    <button type={type} onClick={onclick || undefined} className={`p-[3px] relative ${customClasses}`} disabled={disabled}>
