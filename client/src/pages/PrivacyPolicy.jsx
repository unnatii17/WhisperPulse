  ...
  return (
    <div className='w-full h-full mx-auto text-cFont p-5 md:p-15'>
        <div className='lg:w-[90%] mx-auto bg-gray-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20 border border-gray-400 text-white p-5 md:p-10'>
            ...
            <div className='text-2xl md:text-4xl w-full text-normal text-center'>Privacy Policy for WhisperPulse</div>
            <img src={logo} className='relative mt-0.5 h-[100px] w-[100px] md:h-[60px] md:w-[60px] mx-auto right-3' alt="WhisperPulse logo"/>
            </div>
            <div className='text-xl md:text-2xl my-6 text-justify'>Welcome to WhisperPulse! We take your privacy seriously. This privacy policy explains how we collect, use, and disclose information from and about you when you use our website.</div>
            <ul>
                {policies.map((policy) => (
