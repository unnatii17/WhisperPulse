const welcomeTemplate = (name) => {
	...
	<head>
		<meta charset="UTF-8">
		<title>Welcome to WhisperPulse!</title>
		<style>
			body {
	...
	<body>
		<div class="container">
			<a href="https://github.com/sanchiitvijay/confetti"><img class="logo"
					src="https://res.cloudinary.com/dcnhb3jwv/image/upload/v1720419911/chat-app/confetti_dea0wh.png" alt="WhisperPulse Logo"></a>
			<div class="message">Welcome to WhisperPulse!</div>
			<div class="body">
				<p>Dear ${name},</p>
				<p>We're thrilled to welcome you to WhisperPulse! Your account has been successfully created and you're now part of our vibrant community.</p>
				<p>With WhisperPulse, you can:</p>
			...
			<div class="support">If you have any questions or need assistance, please don't hesitate to reach out to us at 
					href="mailto:whisperpulse.site.01@gmail.com">whisperpulse.site.01@gmail.com</a>. We're here to help!</div>
		</div>
	</body>
