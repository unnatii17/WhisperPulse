...
<head>
    ...
    <title>Reset Password - WhisperPulse</title>
    <style>
        body {
...
<body>
    <div class="container">
        <a href="https://github.com/sanchiitvijay/confetti">
            <img class="logo" src="https://res.cloudinary.com/dcnhb3jwv/image/upload/v1720419911/chat-app/confetti_dea0wh.png" alt="WhisperPulse Logo">
        </a>
        ...
        <div class="support">
            ...
            <a href="mailto:whisperpulse.site.01@gmail.com">whisperpulse.site.01@gmail.com</a>. We're here to help!
        </div>
    </div>
</body>
</html>
